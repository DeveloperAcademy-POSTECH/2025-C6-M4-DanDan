...
## Background
포항 철길숲은 하루 3만 명이 이용하는 포항시의 대표 산책 공간이지만, 단조로운 동선과 반복적인 이용 패턴으로 인해 사용자들이 쉽게 지루함을 느낍니다.  특히 **지속적으로 산책을 할 수 있도록 동기를 제공하는 구조가 부족하다는 문제**를 발견했습니다.

## Solution
스틸워크는 철길숲을 15개 구역으로 나누어, ‘걷기’ 그 자체를 경쟁과 유대감이 생기는 활동으로 재해석한 서비스입니다. 사용자의 **실시간 이동 데이터 기반 구역 점령 경험**, **팀 점수 기여**, **매주 승부 결과**를 제공하며 의미 없이 반복되던 산책을 **재미있고 목표가 생기는 활동**으로 바꿉니다.

## Key Features
- **실시간 산책 기록 & 점령 판정**  
  사용자 이동 데이터를 기반으로 현재 구간의 점령 여부를 정확히 판단합니다.

- **랭킹 시스템**  
  배정된 팀에 자동 참여하며 구역 점령 활동이 팀 점수로 반영됩니다.  
  주 단위로 갱신되는 랭킹이 지속적인 참여 동기를 제공합니다.

- **지도 인터페이스**  
  실시간 이동 3D 트래킹과 함께 점령 구역을 시각적으로 표현하여  
  현재 위치와 이동 경로를 직관적으로 파악할 수 있습니다.

## 스틸워크 게임방법 간단 소개

<div align="center" style="display: flex; flex-wrap: wrap; justify-content: center;">
  <img src="https://github.com/user-attachments/assets/ccff95c8-f4f0-4002-bb69-8f1bb25658a4" width="22%" style="min-width: 150px; margin: 0px;"/>
  <img src="https://github.com/user-attachments/assets/7c45ac08-ab7f-4481-8af6-7eb6d426336b" width="22%" style="min-width: 150px; margin: 0px;"/>
  <img src="https://github.com/user-attachments/assets/cd32bc98-48ec-4e89-ae6b-7d6ac834648a" width="22%" style="min-width: 150px; margin: 0px;"/>
  <img src="https://github.com/user-attachments/assets/931b8f49-ba26-47ea-9ba0-af61fc7d3966" width="22%" style="min-width: 150px; margin: 0px;"/>
</div>
...
[![TypeORM](https://img.shields.io/badge/TypeORM-ff4747?style=for-the-badge&logo=typeorm&logoColor=white)]()
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=for-the-badge&logo=postgresql&logoColor=white)]()
[![SeaweedFS](https://img.shields.io/badge/SeaweedFS-0B7CFF?style=for-the-badge)]()
