                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            TermsSection(
                                title: "제1조(목적)",
                                text: """
                                스틸워크(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.
                                """
                            )
                            ...
                            TermsSection(
                                ...
                                1. 수집목적: 앱의 게임로직 활성화 및 포항시 데이터 수집
                                2. 수집정보: 위치정보
                                """
                            )
                            ...
                            TermsSection(
                                ...
                                가. 포항시청에게 포항시 포항철길숲 이용에 대한 통계학적 수집목적을 위하여 위치정보 데이터를 제공
                                2. 회사는 전항의 제3자 제공 관계에 변화가 있거나 제3자 제공이 종결될 때도 같은 절차에 의해 이용자에게 고지 및 동의를 구합니다.
                                """
                            )
                            ...
                            TermsSection(
                                title: "제14조(개인정보파기방법)",
                                text: """
                                회사는 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 이용하여 삭제하며, 종이로 출력된 개인정보는 분쇄기로 분쇄하거나 소각 등을 통하여 파기합니다.
                                """
                            )
                            ...
                            TermsSection(
                                ...
                                4. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음의 정보에 구체적으로 밝힙니다.
                                가. 회사명 및 연락처
                            ...
                            // 26
                            TermsSection(
                                title: "제26조(국외 이전 개인정보의 보호)",
                                text: """
                                1. 회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계 법규를 위반하는 사항을 내용으로 하는 국제 계약을 체결하지 않습니다.
                                2. 회사는 이용자의 개인정보를 국외에 제공(조회되는 경우를 포함) 처리위탁보관(이하 '이전'이라 함)하려면 이용자의 동의를 받습니다. 다만, 본조 제3항 각 호의 사항 모두를 개인정보보호법 등 관계 법규에 따라 공개하거나 전자우편 등 대통령령으로 정하는 방법에 따라 이용자에게 알린 경우에는 개인정보 처리위탁보관에 따른 동의절차를 거치지 아니할 수 있습니다.
                            ...
                            // 부칙
                            TermsSection(title: "부칙", text: "제1조 본 방침은 2025년.11.10.부터 시행됩니다.")
                        }
